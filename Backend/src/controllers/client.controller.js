...
export const createClient = async (req, res) => {
  try {
    ...
    const brandDescription =
      req.body.brand_description ?? req.body.brandDescription ?? null;

    const instagramEnabled = !!(
      req.body.instagram_enabled ?? req.body.instagramEnabled
    );
    const facebookEnabled = !!(
      req.body.facebook_enabled ?? req.body.facebookEnabled
    );
    const twitterEnabled = !!(
      req.body.twitter_enabled ?? req.body.twitterEnabled
    );
    const linkedinEnabled = !!(
      req.body.linkedin_enabled ?? req.body.linkedinEnabled
    );
    const whatsappEnabled = !!(
      req.body.whatsapp_enabled ?? req.body.whatsappEnabled
    );
    const pinterestEnabled = !!(
      req.body.pinterest_enabled ?? req.body.pinterestEnabled
    );
...
export const getClients = async (req, res) => {
  try {
    ...
    console.log("Debug: getClients called for user:", userId);
